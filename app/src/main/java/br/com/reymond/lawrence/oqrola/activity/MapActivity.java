...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ;
        LatLng LocalParty = (PartyFragment.getPlace());
        mMap.addMarker(new MarkerOptions().position(LocalParty).title(PartyFragment.getParty()));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LocalParty, 15));
    }
